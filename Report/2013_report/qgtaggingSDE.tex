...
power, \textit{i.e.}, the quark and gluon distributions are most distinct, as was originally noted in \refneeded. 
...
such as $\alpha = 0.01$, produces better results\refneeded). The combination of all variables shows somewhat better discrimination, and
...
\begin{figure*}
\centering
\subfigure[$\rm{N_ {constits}}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/Ncon.png}}
\subfigure[$\Gamma_{Qjet}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/GamQ.png}}
...
\begin{figure*}
\centering
\subfigure[$C_1^{\beta=1}+\tau_{1}^{\beta=1}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/C11Tau11.png}}
\subfigure[$C_1^{\beta=2}+\tau_{1}^{\beta=2}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/C12Tau12.png}}
%\subfigure[$C_1^{\beta=0}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/C10.png}}\\
%\subfigure[$C_1^{\beta=1}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/C11.png}}
%\subfigure[$\tau_{1}^{\beta=1}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/Tau11.png}}\\
%\subfigure[$C_1^{\beta=2}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/C12.png}}
...
\begin{figure*}
\centering
\subfigure[$\rm{N_ {constits}}+\Gamma_{Qjet}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/NconGamQ.png}}
\subfigure[$\rm{N_ {constits}}+ C_1^{\beta=1}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/NconC11.png}}
\subfigure[$\rm{N_ {constits}}+ C_1^{\beta=2}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/NconC12.png}}\\
\subfigure[$\rm{N_ {constits}}+ C_1^{\beta=0}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/NconC10.png}}
\subfigure[$\Gamma_{Qjet}+ C_{1}^{\beta=0}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/C10GamQ.png}}
\subfigure[$\Gamma_{Qjet}+ C_{1}^{\beta=1}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/C11GamQ.png}}\\
\subfigure[$\Gamma_{Qjet}+ C_{1}^{\beta=2}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/C12GamQ.png}}
\subfigure[$ C_{1}^{\beta=0}+ C_{1}^{\beta=1}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/C10C11.png}}
...
defined 4-momentum.  It follows that 4-momentum of the jet  is simply the sum of the 4-momenta of the constituents and its square is the jet mass squared.
...
and that is set by $R$.  The mass distributions for quark and gluon jets for all of our kinematic points are indicated in Figure~\ref{fig:qg_masses_log}, where
...
for the different kinematic points do approximately scale, \textit{i.e.}, the simple arguments above do capture most of the variation in the unscaled distributions.
...
\caption{Comparisons of quark and gluon pruned mass distributions versus the scaled variable $m/p_T/R$. }
...
(singular in both $\pt$ and angle) to all orders in perturbation theory yields a distribution that is highly damped  as the mass vanishes.  In words, there is precisely zero
probability that a color parton emits no radiation (and the resulting jet has zero mass). 
 The large mass ``shoulder" ($0.3 < m/p_T/R < 0.5$) is driven largely by the presence of a single large angle, energetic
emission in the underlying QCD shower, \textit{i.e.}, this regime is well described by low-order perturbation theory.  (The shoulder label will be more clear after we groom the jet.)
In contrast, we should think as the peak region as corresponding to multiple soft emissions.  This simple (approximate) picture allows an understanding of the
...
Similarly the exponent in the Sudakov damping factor is enhanced by the same factor, leading to a peak ``pushed'' further from the origin.  So the gluon jet mass 
...
the number of constituents in the jet is also larger for the gluon jet.  This feature that the shoulder plays a larger role for the gluon jet provides an explanation
for the difference in the observable $\Gamma_{Qjet}$.  Since the shoulder is dominated by a single large angle, hard emission, ii is minimally impacted by pruning,
...
Figure~\ref{fig:qg_pt500_subst_AKt_R08}(b).

Figure~\ref{fig:qg_mprasses_log} exhibits the jet mass distributions (of  Figure~\ref{fig:qg_masses_log}) after pruning.  Removing the large angle,  soft constituents
moves the peak in the distributions from  $m/p_T/R ~ 0.1 - 0.2$ to the region around $m/p_T/R ~ 0.05$.