...
$N$-subjettiness; recently, it was shown that the ``winner-takes-all'' (WTA) axes can be easily computed and have superior performance compared to other minimization techniques\refneeded. We use both the WTA and one-pass $k_t$ optimization axes in our analyses.
