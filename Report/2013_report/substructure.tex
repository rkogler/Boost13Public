...
\label{sec:groomers}
 ...
 \end{equation}
 %
 in which case the merger is vetoed and the softer branch  discarded. The default parameters used for pruning \cite{Ellis:2009me} in most studies in this report are $z_{\rm cut}=0.1$ and $R_{\rm cut}=0.5$. One advantage of pruning is that the thresholds used
 ...
 \end{equation}
 %
 The default parameters used for trimming \cite{Krohn:2009th} in most studies in this report are $R_{\rm trim}=0.2$ and $f_{\rm cut}=0.03$.\\
