...
calculation of jet substructure observables. Jets are clustered using the anti-$k_t$ algorithm, and only the leading jet is used in each analysis. An upper and lower $\pt$ cut are applied after jet clustering
