...
\begin{figure*}
\begin{center}
\subfigure[Johns Hopkins Tagger, $\pt=600-700$ GeV]{\includegraphics[width=0.4\textwidth]{./Figures/TTagging/single_variable/pT.600GeV.R.0.8/h_JH_mt_pT_0_6.pdf}}
\subfigure[HEPTopTagger, $\pt=600-700$ GeV]{\includegraphics[width=0.4\textwidth]{./Figures/TTagging/single_variable/pT.600GeV.R.0.8/h_HEP_mt_pT_0_6.pdf}}
\subfigure[Johns Hopkins Tagger, $\pt=1-1.1$ TeV]{\includegraphics[width=0.4\textwidth]{./Figures/TTagging/single_variable/pT.1TeV.R.0.8/h_JH_mt_pT_1_0.pdf}}
\subfigure[HEPTopTagger, $\pt=1-1.1$ TeV]{\includegraphics[width=0.4\textwidth]{./Figures/TTagging/single_variable/pT.1TeV.R.0.8/h_HEP_mt_pT_1_0.pdf}}
\subfigure[Johns Hopkins Tagger, $\pt=1.5-1.6$ TeV]{\includegraphics[width=0.4\textwidth]{./Figures/TTagging/single_variable/pT.1.5TeV.R.0.8/h_JH_mt_pT_1_5.pdf}}
\subfigure[HEPTopTagger, $\pt=1.5-1.6$ TeV]{\includegraphics[width=0.4\textwidth]{./Figures/TTagging/single_variable/pT.1.5TeV.R.0.8/h_HEP_mt_pT_1_5.pdf}}
\caption{Comparison of top mass reconstruction with the JH and HEPTopTaggers at different $\pt$ using the anti-\kT algorithm, $R=0.8$. Each histogram is shown for the working point optimized for best performance with $m_t$ in the $0.3-0.35$ signal efficiency bin, and is normalized to the fraction of events passing the tagger.}
...
Up to this point we have just considered the combined multivariable performance in the \pt 1.0-1.1 TeV bin with jet radius R=0.8. 
...
The degradation in performance is more pronounced for the BDT combinations of the full tagger outputs (see Fig.~\ref{fig:ptcomparison_top_optOnce}), particularly at very low signal efficiency where the optimization picks out a cut on the tail of some distribution that depends precisely on the $\pt$/$R$ of the jet. Once again, trimming and the Johns Hopkins tagger degrade more markedly.   
