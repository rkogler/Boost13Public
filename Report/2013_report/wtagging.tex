...
this changes with jet boost and jet radius. Using BDT combinations of substructure variables to improve W tagging has been studied earlier in 
\cite{Cui:2010km}.
...
different groomed masses (first shown in \cite{Soper:2010xk}). In addition, there is an improvement in the
