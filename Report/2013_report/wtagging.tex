...
\begin{itemize}
\item Ungroomed, trimmed (\mtrim), and pruned (\mprun) jet masses.
\item Mass output from the modified mass drop tagger (\mmdt).
\item Soft drop mass with $\beta=-1,\,2$ (\msd).
...
studied (using the same jet radius and \pt bin). 

\begin{figure*}
\centering
\subfigure[Ungroomed mass]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/jmass1.eps}}
\subfigure[Pruned mass]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_mass_prun.eps}}
\subfigure[Trimmed mass]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_mass_trim.eps}}\\
\subfigure[mMDT mass]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_mass_mmdt.eps}}
\subfigure[Soft-drop $\beta=2$ mass]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_mass_sdb2.eps}}
%\subfigure[Soft-drop $\beta=-1$ mass]{\includegraphics[width=0.48\textwidth]{./Figures/figs072514/figs071614_Wg_bin500_ak08/oneD/h_mass_sdm1.eps}}
...
\begin{figure*}
\centering
\subfigure[$C_2^{\beta=1}$]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_c2_b1.eps}}
\subfigure[$C_2^{\beta=2}$]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_c2_b2.eps}}
\subfigure[$\Gamma_{Qjet}$]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_qjetVol.eps}}\\
\subfigure[$\tau_{21}^{\beta=1}$]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_tau21_b1.eps}}
\subfigure[$\tau_{21}^{\beta=2}$]{\includegraphics[width=0.30\textwidth]{./Figures/WTagging/pT500/AKtR08/h_tau21_b2.eps}}
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.8$, \pt 300-400 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR08/Rocs_1D_single.eps}}
\subfigure[\antikt $R=1.2$, \pt 300-400 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR12/Rocs_1D_single.eps}}
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.8$, \pt 500-600 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR08/Rocs_1D_single.eps}}
\subfigure[\antikt $R=1.2$, \pt 500-600 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR12/Rocs_1D_single.eps}}
\caption{ROC curves for single variables considered for $W$
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.4$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR04/Rocs_1D_single.eps}}
\subfigure[\antikt $R=0.8$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR08/Rocs_1D_single.eps}}\\
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR12/Rocs_1D_single.eps}}
\caption{ROC curves for single variables considered for $W$
...
%\begin{figure*}
%\centering
%\includegraphics[width=0.8\textwidth]{./Figures/figs072514/figs071614_Wg_bin500_ak12/Rocs_1D_single.eps}
...
and~\ref{fig:pt1000_comb2D}, we present the same information in a format that more readily allows for a quantitative comparison of performance for different $R$ and \pt. We show matrices which give the
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.8$, \pt 300-400 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR08/effBkg2D.eps}\label{fig:pt300_comb2D_08}}
\subfigure[\antikt $R=1.2$, \pt 300-400 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR12/effBkg2D.eps}\label{fig:pt300_comb2D_12}}
\caption{
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.8$, \pt 500-600 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR08/effBkg2D.eps}\label{fig:pt500_comb2D_08}}
\subfigure[\antikt $R=1.2$, \pt 500-600 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR12/effBkg2D.eps}\label{fig:pt500_comb2D_12}}
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.4$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR04/effBkg2D.eps}\label{fig:pt1000_comb2D_04}}
\subfigure[\antikt $R=0.8$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR08/effBkg2D.eps}\label{fig:pt1000_comb2D_08}}\\
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR12/effBkg2D.eps}\label{fig:pt1000_comb2D_12}}
\caption{The background rejection
for a fixed signal efficiency (70\%) of each BDT combination of
...
Soft-drop $\beta=2$ groomed mass and the pruned mass for signal and background in the \pt
300-400 and \pt 1.0-1.1 TeV bins for R=1.2 jets. Two effects result in the improved
...
\begin{figure*}
\centering
\subfigure[\antikt $R=1.2$, \pt 300-400 GeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT300/AKtR12/h_mass_sdb2.eps}}
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR12/h_mass_sdb2.eps}}
\subfigure[\antikt $R=1.2$, \pt 300-400 GeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT300/AKtR12/h_mass_prun.eps}}
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR12/h_mass_prun.eps}}
...
300-400 and \pt 1.0-1.1 TeV bins for R=0.8 jets. For
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.8$, \pt 300-400 GeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT300/AKtR08/h_tau21_b1.eps}}
\subfigure[\antikt $R=0.8$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR08/h_tau21_b1.eps}}
\subfigure[\antikt $R=0.8$, \pt 300-400 GeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT300/AKtR08/h_c2_b1.eps}}
\subfigure[\antikt $R=0.8$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR08/h_c2_b1.eps}}
...
\begin{figure*}
\centering
\subfigure[\antikt $R=0.4$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR04/h_mass_sdb2.eps}}
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR12/h_mass_sdb2.eps}}
\subfigure[\antikt $R=0.4$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR04/h_mass_prun.eps}}
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR12/h_mass_prun.eps}}
\caption{The Soft-drop $\beta=2$ and pruned groomed mass distribution for signal
  and background $R=0.4$ and $R=1.2$ jets in the 1.0-1.1 TeV \pt~bin.}
...
\centering
\subfigure[\antikt $R=0.8$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR08/h_tau21_b1.eps}}
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR12/h_tau21_b1.eps}}
\subfigure[\antikt $R=0.8$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR08/h_c2_b1.eps}}
\subfigure[\antikt $R=1.2$, \pt 1.0-1.1 TeV bin]{\includegraphics[width=0.4\textwidth]{./Figures/WTagging/pT1000/AKtR12/h_c2_b1.eps}}
\caption{The $\tau_{21}^{\beta=1}$ and $C_2^{\beta=1}$ distributions for signal
  and background $R=0.8$ and $R=1.2$ jets in the 1.0-1.1 TeV \pt~bin.}
...
among jet observables, which we address in this section. The off-diagonal entries in Figures~\ref{fig:pt300_comb2D},~\ref{fig:pt500_comb2D}
...
\begin{figure*}
\centering
\subfigure[\pt = 300-400 GeV]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT300/AKtR08/h2d_jc2_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt300_2d_c2b1_AKt_R08}}
\subfigure[\pt = 500-600 GeV]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT500/AKtR08/h2d_jc2_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt500_2d_c2b1_AKt_R08}}
\subfigure[\pt = 1.0-1.1 TeV]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR08/h2d_jc2_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt1000_2d_c2b1_AKt_R08}}
\caption{2-D histograms of $m_{sd}^{\beta=2}$ versus $C_2^{\beta=1}$
  distributions for $R=0.8$ jets in the various \pt bins considered.}
...
\begin{figure*}
\centering
\subfigure[$R=0.4$]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR04/h2d_jc2_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt1000_2d_c2b1_AKt_R04}}
\subfigure[$R=0.8$]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR08/h2d_jc2_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt1000_2d_c2b1_AKt_R08_b}}
\subfigure[$R=1.2$]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR12/h2d_jc2_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt1000_2d_c2b1_AKt_R12}}
\caption{2-D histograms of $m_{sd}^{\beta=2}$ versus $C_2^{\beta=1}$
...
\begin{figure*}
\centering
\subfigure[$R=0.4$]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR04/h2d_jtau21_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt1000_2d_tau21_AKt_R04}}
\subfigure[$R=0.8$]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR08/h2d_jtau21_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt1000_2d_tau21_AKt_R08_b}}
\subfigure[$R=1.2$]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR12/h2d_jtau21_b1_j_mass_sdb2_WW_onSame.eps}\label{fig:pt1000_2d_tau21_AKt_R12}}
...
\begin{figure*}
\centering
\subfigure[Pruned mass vs ungroomed mass]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR04/h2d_jmass_j_mass_prun_WW_onSame.eps}\label{fig:pt1000_2d_prun_AKt_R04}}
\subfigure[Trimmed mass vs ungroomed mass]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR04/h2d_jmass_j_mass_trim_WW_onSame.eps}\label{fig:pt1000_2d_trim_AKt_R04}}
\caption{2-D histograms showing the correlation between groomed and
...
\begin{figure*}
\centering
\subfigure[Pruned mass vs ungroomed mass]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR08/h2d_jmass_j_mass_prun_WW_onSame.eps}\label{fig:pt1000_2d_prun_AKt_R08}}
\subfigure[Trimmed mass vs ungroomed mass]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR08/h2d_jmass_j_mass_trim_WW_onSame.eps}\label{fig:pt1000_2d_trim_AKt_R08}}
\caption{2-D histograms showing the correlation between groomed and
  ungroomed mass for $WW$ and $gg$ events in the \pt = 1.0-1.1 TeV bin using the
...
\begin{figure*}
\centering
\subfigure[Pruned mass vs ungroomed mass]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR12/h2d_jmass_j_mass_prun_WW_onSame.eps}\label{fig:pt1000_2d_prun_AKt_R12}}
\subfigure[Trimmed mass vs ungroomed mass]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR12/h2d_jmass_j_mass_trim_WW_onSame.eps}\label{fig:pt1000_2d_trim_AKt_R12}}
\caption{2-D histograms showing the correlation between groomed and
  ungroomed mass for $WW$ and $gg$ events in the \pt = 1.0-1.1 TeV bin using the
