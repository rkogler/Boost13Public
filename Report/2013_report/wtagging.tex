...
(lead jet \pt 300-450 GeV, 500-650 GeV, 1.0-1.2 TeV). This allows us to determine the
...
leading jet \pt for the signal and background in the \pt 300-450 GeV bin, for the two different \antikt jet
...
\emph{(BS: Do we need to show the \pt spectra? Since we end up cutting in a narrow bin, it hopefully shouldn't make a difference.)}
...
\caption{Comparisons of the leading jet \pt spectrum of the $gg$
  background to the WW signal in the \pt 300-450 GeV bin using the
...
\caption{Comparisons of the leading jet \pt spectrum of the $gg$
  background to the WW signal in the \pt 500-650 GeV bin using the
  different \antikt jet distance parameters explored.}
...
\caption{Comparisons of the leading jet \pt spectrum of the $gg$
  background to the WW signal in the \pt 1.0-1.2 TeV bin using the
  different \antikt jet distance parameters explored.}
...
%\pT]{\includegraphics[width=0.48\textwidth]{./Figures/figs072514/figs071614_Wg_bin500_ak08/jpt1.png}}
%\subfigure[Sub-leading jet
%\pT]{\includegraphics[width=0.48\textwidth]{./Figures/figs072514/figs071614_Wg_bin500_ak08/jpt2.png}}
%\subfigure[Leading jet
%$\eta$]{\includegraphics[width=0.48\textwidth]{./Figures/figs072514/figs071614_Wg_bin500_ak08/jeta1.png}}
%\subfigure[Sub-leading jet
%$\eta$]{\includegraphics[width=0.48\textwidth]{./Figures/figs072514/figs071614_Wg_bin500_ak08/jeta2.png}}
...
\antikt R=0.8 algorithm in the \pt 500-650 bin. One can clearly see
...
\caption{Comparisons of the QCD background to the WW signal in the \pt 500-650 GeV bin using the anti-\kT R=0.8 algorithm: leading
...
\caption{Comparisons of the QCD background to the WW signal in the \pt 500-650 GeV bin using the anti-\kT R=0.8 algorithm:
...
\begin{figure*}
\begin{center}
\subfigure[\antikt R=0.8, \pt 300-450 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR08/Rocs_1D_single.png}}
\subfigure[\antikt R=1.2, \pt 300-450 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR12/Rocs_1D_single.png}}
\caption{The ROC curve for all single variables considered for $W$
tagging in the \pt 300-450 GeV bin using the anti-\kT R=0.8 algorithm and R=1.2 algorithm.}
...
\begin{figure*}
\begin{center}
\subfigure[\antikt R=0.8, \pt 500-650 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR08/Rocs_1D_single.png}}
\subfigure[\antikt R=1.2, \pt 500-650 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR12/Rocs_1D_single.png}}
\caption{The ROC curve for all single variables considered for $W$
tagging in the \pt 500-650 GeV bin using the anti-\kT R=0.8 algorithm and R=1.2 algorithm.}
...
\begin{figure*}
\begin{center}
\subfigure[\antikt R=0.4, \pt 1.0-1.2 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR04/Rocs_1D_single.png}}
\subfigure[\antikt R=0.8, \pt 1.0-1.2 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR08/Rocs_1D_single.png}}\\
\subfigure[\antikt R=1.2, \pt 1.0-1.2 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR12/Rocs_1D_single.png}}
\caption{The ROC curve for all single variables considered for $W$
tagging in the \pt 1.0-1.2 TeV bin using the anti-\kT R=0.4 algorithm,
...
\begin{figure*}
\begin{center}
\subfigure[\antikt R=0.8, \pt 300-450 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR08/effBkg2D.png}\label{fig:pt300_comb2D_08}}
\subfigure[\antikt R=1.2, \pt 300-450 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT300/AKtR12/effBkg2D.png}\label{fig:pt300_comb2D_12}}
\caption{
The background rejection
for a fixed signal efficiency (50\%) of each BDT combination of
each pair of variables considered, in the \pt 300-450 GeV bin using the anti-\kT R=0.8
...
\begin{figure*}
\begin{center}
\subfigure[\antikt R=0.8, \pt 500-650 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR08/effBkg2D.png}\label{fig:pt500_comb2D_08}}
\subfigure[\antikt R=1.2, \pt 500-650 GeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR12/effBkg2D.png}\label{fig:pt500_comb2D_12}}
\caption{The background rejection
for a fixed signal efficiency (50\%) of each BDT combination of
each pair of variables considered, in the \pt 500-650 GeV bin using the anti-\kT R=0.8
algorithm and R=1.2 algorithm. Also shown is the background rejection
for a BDT combination of all of the variables considered.}
...
\begin{figure*}
\begin{center}
\subfigure[\antikt R=0.4, \pt 1.0-1.2 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR04/effBkg2D.png}\label{fig:pt1000_comb2D_04}}
\subfigure[\antikt R=0.8, \pt 1.0-1.2 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR08/effBkg2D.png}\label{fig:pt1000_comb2D_08}}\\
\subfigure[\antikt R=1.2, \pt 1.0-1.2 TeV bin]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT1000/AKtR12/effBkg2D.png}\label{fig:pt1000_comb2D_12}}
\caption{The background rejection
for a fixed signal efficiency (50\%) of each BDT combination of
each pair of variables considered, in the \pt 1.0-1.2 TeV bin using
...
\begin{figure*}
\begin{center}
\subfigure[\pt 300-450 GeV]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT300/AKtR08/h2d_jc2_b1_j_mass_sdb2_WW_onSame.png}\label{fig:pt300_2d_c2b1_AKt_R08}}
\subfigure[\pt 500-650 GeV]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT500/AKtR08/h2d_jc2_b1_j_mass_sdb2_WW_onSame.png}\label{fig:pt500_2d_c2b1_AKt_R08}}
\subfigure[\pt 1.0-1.2 TeV]{\includegraphics[width=0.78\textwidth]{./Figures/WTagging/pT1000/AKtR08/h2d_jc2_b1_j_mass_sdb2_WW_onSame.png}\label{fig:pt1000_2d_c2b1_AKt_R08}}
...
\caption{2-D plots showing $m_{sd}^{\beta=2}$ versus $C_2^{\beta=1}$
  for R=0.4, 0.8 and 1.2 jets in the \pt~1.0-1.2 TeV bin.}
...
\caption{2-D plots showing the correlation between groomed and
  ungroomed mass for $WW$ and $gg$ events in the \pt 1.0-1.2 TeV bin using the
