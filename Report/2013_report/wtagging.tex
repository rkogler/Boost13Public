...
\begin{figure*}
\begin{center}
\subfigure[mMDT mass vs $C_2^{\beta=1}$]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR08/h2d_jc2_b1_j_mass_mmdt_WW_onSame.png}}
\subfigure[mMDT mass vs $\Gamma_{Qjet}$]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR08/h2d_j_qjetVol_j_mass_mmdt_WW_onSame.png}}
\subfigure[mMDT mass vs $\tau_{21}^{\beta=1}$]{\includegraphics[width=0.48\textwidth]{./Figures/WTagging/pT500/AKtR08/h2d_jtau21_b1_j_mass_mmdt_WW_onSame.png}}
\caption{2-D plots showing the correlation between mMDT mass and
  various substructure vairables in the \pt 500 GeV bin using the anti-\kT R=0.8 algorithm.}
