...
{\bf (ED: Do we need to show the \pt spectra? Since we end up cutting in a narrow bin, it hopefully shouldn't make a difference.)}
...
the groomed masses increases with increasing \pt, with a factor 1.5-2 increase in rejection in going from the 300-400 GeV to
