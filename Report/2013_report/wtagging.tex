...
\pt~for R=1.2. The background rejection power of
the groomed masses increases slowly with increasing \pt, with at
most a factor two increase in rejection in going from the 300-450 GeV to
1.0-1.2 TeV bins. 
However, for a jet radius of R=0.8, the rejection power of
$C_2^{\beta=1}$ increases dramatically with \pt, by a factor of 7 in going from
the 300-450 GeV to 1.0-1.2 TeV bins. {\it Can we explain this?} Conversely, the background rejection
of the other substructure variables ($\Gamma_{Qjet}$ and
$\tau_{21}^{\beta=1}$) slowly reduces with increasing \pt, at most
...
radius of R=1.2 (more than an order of magnitude worse background rejection in
the 1.0-1.2 TeV bin), and substantially worse for R=0.4. For the other
jet substructure variables considered, their background rejection
...
variables are not powerful in comparison. The background rejection of
...
One can also see that there is a modest improvement in
...
different groomed masses. There is also an improvement in the
...
discriminatory information from the jet.
