...
\centering
<<<<<<< HEAD
\subfigure[$\rm{N_ {constits}}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_multiplicity.eps}}
\subfigure[$\Gamma_{Qjet}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_qjetVol.eps}}
\subfigure[$C_1^{\beta=0}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_c1_b0.eps}}\\
\subfigure[$C_1^{\beta=1}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_c1_b1.eps}}
\subfigure[$\tau_{1}^{\beta=1}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_tau1_b1.eps}}\\
\subfigure[$C_1^{\beta=2}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_c1_b2.eps}}
\subfigure[$\tau_{1}^{\beta=2}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_tau1_b2.eps}}
\subfigure[Ungroomed mass]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/jmass1.eps}}
...
\subfigure[$\Gamma_{\rm Qjet}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGTagging/pT500/AKtR08/h_qjetVol.png}}
...
>>>>>>> efd6e04b7523a83da436ad71d79b5b94fb893723
...
%\includegraphics[width=0.4\textwidth]{./Figures/QGTagging/pT1000/AKtR04/Rocs_1D_single.eps}\\
\includegraphics[width=0.48\textwidth]{./Figures/QGTagging/pT300/AKtR08/Rocs_1D_single.eps}
%\includegraphics[width=0.4\textwidth]{./Figures/QGTagging/pT1000/AKtR08/Rocs_1D_single.eps}\\
\includegraphics[width=0.48\textwidth]{./Figures/QGTagging/pT300/AKtR12/Rocs_1D_single.eps}
%\includegraphics[width=0.4\textwidth]{./Figures/QGTagging/pT1000/AKtR12/Rocs_1D_single.eps}\\
...
\subfigure[$\Gamma_{\rm Qjet}$]{\includegraphics[width=0.30\textwidth]{./Figures/QGSurface/GamQ.png}}
...
and the variation with $\pt$ and $R$ for each of the studied single observable.  We organize our results by class:
%The color shading is defined so that a change in color 
...
\begin{figure*}
\centering
\subfigure[$\rm{N_ {constits}}+\Gamma_{\rm Qjet}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/NconGamQ.png}}
...
\subfigure[$\Gamma_{\rm Qjet}+ C_{1}^{\beta=0}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/C10GamQ.png}}
\subfigure[$\Gamma_{\rm Qjet}+ C_{1}^{\beta=1}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/C11GamQ.png}}\\
\subfigure[$\Gamma_{\rm Qjet}+ C_{1}^{\beta=2}$]{\includegraphics[width=0.28\textwidth]{./Figures/QGSurface/C12GamQ.png}}
...
Next, we consider  cross-class pairs of observables  in Figure~\ref{fig:qg_surface_pairB}, where for each class we only use a single observable for illustrative purposes.
...
asat higher $\pt$.  At the same time, and for the same reason, the Sudakov damping is less strong with increasing $\pt$ and the peak moves in towards the origin.
