...
reduce the $R$ and $\pt$ dependence for the pair, but this also serves to reduce the possible optimization of the observables required.  The other pairs shown exhibit
similar behavior.  
