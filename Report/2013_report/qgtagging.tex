...
These studies use the XXX samples described previously in Section~\ref{sec:samples}.

Jets are reconstructed using the XXX jet algorithms described in Section~\ref{sec:jetalgs}. The following event selection is then applied to these
...
Figure~\ref{fig:qg_pt500_basics_AKt_R08} shows
background versus signal in some basic kinematic
distributions. {\it Do we want to reweight quark kinematics to gluon or vice versa?}
